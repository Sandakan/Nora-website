...
const feedbackList = [
  {
    ...
    link:
      "https://www.softpedia.com/get/Multimedia/Audio/Audio-Players/Oto-Music-for-Desktop.shtml",
    images: {
  ...
  },
  {
    ...
    link:
      "https://www.reddit.com/r/windowsapps/comments/11xgg99/just_found_the_most_beautiful_music_player_for/",
    images: {
      ...
      return (
        <button
          ...
          className={`mr-3 h-3 w-3 rounded-full border-2 border-solid border-font-color bg-transparent transition-[color,border-color,transform] last:mr-0 dark:border-white ${
            i === visibleFeedbackNumber &&
            "!scale-110 !bg-font-color dark:!bg-white"
          }`}
  ...
  return (
    ...
    >
      <div className="flex h-[22rem] flex-col items-center justify-center text-center">
        <p className="mb-4 py-2 text-3xl font-medium [text-wrap:balance]">
          What Users think about Nora
        </p>
        <div
