...
const FeedbackComponent = (props: Props) => {
  ...
  return (
    ...
    >
      <q className="text-base dark:text-white sm:text-xl md:text-2xl">
        {feedback}
      </q>
      <a
        href={link}
      ...
      >
        ...
        {images && (
          <img
            src={isDarkMode ? images.dark : images.light}
            className={`hidden sm:block ${images.className}`}
            alt=""
          />
        )}
      </a>
