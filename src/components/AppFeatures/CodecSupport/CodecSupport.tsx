	...
	return (
		<div
			...
			<div className="flac-group flex items-center justify-center md:flex-col">
				...
				<TripleDots />
				<span className="text-6xl font-semibold drop-shadow-xl md:text-8xl">FLAC</span>
				<TripleDots />
			...
			<div className="saying-group flex flex-col items-center justify-center text-center">
				...
				<p className="mt-2 px-2 dark:text-font-white">Support for lossless audio through FLAC and WAV.</p>
			</div>
			<div className="wav-group flex items-center justify-center md:flex-col">
				...
				<TripleDots />
				<span className="text-6xl font-semibold drop-shadow-xl md:text-8xl">WAV</span>
				<TripleDots />
